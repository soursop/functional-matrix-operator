...
class Assert {
    ...
    static void assertElementSize(Object applier, DoubleMatrix one, DoubleMatrix other) {
    ...
    static void assertProductSize(Object applier, DoubleMatrix one, DoubleMatrix other) {
